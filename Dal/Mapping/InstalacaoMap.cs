...
namespace Dal.Mapping {
  internal class InstalacaoMap : EntityTypeConfiguration<Instalacao> {
    public InstalacaoMap() {
      // Primary Key
      this.HasKey(t => t.Id);
     
      // Table, Properties & Column Mappings
      this.ToTable("Instalacoes", "opc");
      ...
      this.HasRequired(t => t.Empresa)
          .WithMany(t => t.Instalacoes).HasForeignKey(d => d.EmpresaId).WillCascadeOnDelete(false);
    }
  }
}
