...
namespace Dal.Mapping {
  internal class PtDestinoMap : EntityTypeConfiguration<PtDestino> {
    public PtDestinoMap() {
      // Primary Key
      this.HasKey(t => t.Id);
      ...
      this.HasRequired(t => t.Linha)
          .WithMany(t => t.PtDestinos).HasForeignKey(d => d.LinhaId);

      this.HasRequired(t => t.Ponto)
          .WithMany(t => t.PtDestinos).HasForeignKey(d => d.PontoId);
    }
  }
}
